...
export default async function Hero() {
  ...
  const fitTitle = isRu
    ...
    : "";
  // Висота першого екрана на мобільному — за контентом. Фіксовані 864 px
  // лишились від десктопної композиції: на телефоні контент закінчується
  // приблизно на 657 px, і під месенджерами висіло ~200 px порожнечі.
  // З md висота знову фіксована — там від неї залежить розкладка хмар і фону.
  return (
    <div className="overflow-x-clip relative md:h-[864px]">
