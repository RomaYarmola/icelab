...
export default function DeliveryBg() {
  return (
    <>
      <div className="absolute w-[2447px] radial-white-gradient min-h-[716px] xs:min-h-[600px] md:min-h-[495px] md:max-h-[495px] top-[312px]  md:top-[483px] left-1/2 transform -translate-x-1/2 z-[1] md:blur-[72px]" />
